<%-- 
    Document   : report-provincial-detail.jsp
    Created on : Dec 9, 2020, 12:21:10 PM
...
<div class="main-content">
    ...
    <h2 class="h2-text">ข้อมูลรับสมัคร "ส่วนภูมิภาค" </h2>
    <p class="p-text">รายงานจำนวนผู้สมัครเรียนระดับปริญญาตรี</p>

    <div class="container-content">
        <div class="container-btn-submit">
            <!--action="/studentsReport/ReportProvincialDetailReport"-->
            <form action="/studentsReport/ReportProvincialDetailReport" method="POST" onsubmit="return validationSigninCheck()">       
                <label for="">
