<%-- 
    Document   : report- central
    Created on : Nov 9, 2020, 9:39:37 AM
...
<div class="main-content">
    ...
    <h2 class="h2-text">ออกรายงาน "ส่วนกลาง"</h2>
    <p class="p-text">รายงานจำนวนผู้สมัครเรียนระดับปริญญาตรี</p>
    <p class="p-text-central-provincial">นำออกไฟล์รายงาน "ส่วนกลาง" Excel file...</p>

    <div class="container-content">
        <div class="container-btn-submit">
            <form action="/studentsReport/ReportCenralExportExcel" method="POST" onsubmit="return validationSigninCheck()">       
                <label for="">
...
<script type="text/javascript">
    ...
    let exEx = '<%=request.getAttribute("export-excel")%>';
    let isExEx = exEx === 'success' ? document.querySelector('.p-text-selector-check').innerHTML = "" : null;
